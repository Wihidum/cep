...
public interface CEPConstants {
    ...
    String CEP_CONF_ATTR_TYPE = "type";
    String CEP_CONF_ATTR_XPATH = "xpath";
    ...
    String CEP_CONF_ELE_TEXT_MAPPING = "textMapping";
    ...
    String CEP_CONF_ATTR_VALUE_OF = "valueOf";
    String CEP_CONF_ATTR_INPUT_NAME = "inputName";
    ...
    String CEP_CONF_TYPE_TUPLE = "Tuple";
    ...
    String CEP_CONF_ELE_TUPLE_DATA_TYPE_META =CEP_CONF_TUPLE_DATA_TYPE_META;
    String CEP_CONF_ELE_TUPLE_DATA_TYPE_CORRELATION =CEP_CONF_TUPLE_DATA_TYPE_CORRELATION ;
    String CEP_CONF_ELE_TUPLE_DATA_TYPE_PAYLOAD =CEP_CONF_TUPLE_DATA_TYPE_PAYLOAD ;
